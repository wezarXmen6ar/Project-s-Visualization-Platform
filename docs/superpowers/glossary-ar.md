...
- **Numbers:** Western digits (0–9). Percentages are written "60%". Dates are Gregorian with Arabic names: "الاثنين 12 أكتوبر 2026", "12 أكتوبر".
- **Gender and number:** labels for a person's role aren't gendered where Arabic allows it; where it doesn't, use the masculine as the generic form. Counts use the correct Arabic plural forms (one, two, 3–10, 11+), for example "مهمة واحدة", "مهمتان", "3 مهام", "11 مهمة".

## Areas and pages
| English | Arabic | Note |
|---|---|---|
| Project Management | إدارة المشاريع | |
| Project Presentation | عرض المشاريع | |
| Projects (dashboard title) | المشاريع | |
...
| Follow-on project | مرحلة تالية من المشروع | M11 (user, 2026-09-26) |
...
| English | Arabic | Note |
|---|---|---|
| Phase / Phases | مرحلة / المراحل | |
| Sub-phase | مرحلة فرعية | |
| Starts with the phase | تبدأ مع بداية المرحلة | |
| After the ones above | بعد انتهاء ما قبلها | |
| With the one above | بالتزامن مع السابقة | |
...
| English | Arabic |
|---|---|
| Save / Cancel / Edit / Delete / Remove | حفظ / إلغاء / تعديل / حذف / إزالة |
| Add / Add person / Add phase / Add sub-phase | إضافة / إضافة شخص / إضافة مرحلة / إضافة مرحلة فرعية |
| Next / Back / Create project | التالي / السابق / إنشاء المشروع |
| Save anyway / Keep editing | حفظ على أي حال / متابعة التعديل |
