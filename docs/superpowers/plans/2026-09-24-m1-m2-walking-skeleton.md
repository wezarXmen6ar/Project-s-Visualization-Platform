...
| M13 | Stakeholder presentation | Health model, ⭐ milestones and upcoming milestones, the finished charts with drill-down; **plus polish for presenting (was a separate milestone):** PDF export, presenter mode |
