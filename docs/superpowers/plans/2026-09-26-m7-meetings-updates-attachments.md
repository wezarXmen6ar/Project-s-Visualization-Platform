...
- **Deleting a meeting or update** keeps its attachments (they become attachments of the project) and its to-dos (their "from the meeting" link is cleared). You confirm before deleting. In M13 (Requirement readiness), deleting something used as evidence will warn first.
